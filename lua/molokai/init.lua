...
function molokai.setup()
	...
	local highlights = {
		...
		{ "@diff.delta", { fg = colors.white, bg = colors.boring_gray, ctermfg = 255, ctermbg = 239 } },
		{ "@diff.add", { fg = colors.bright_green, ctermfg = 46 } },
		{ "@diff.delete", { fg = colors.bright_red, ctermfg = 196 } },
		{ "@diff.change", { fg = colors.white, bg = colors.boring_gray, ctermfg = 255, ctermbg = 239 } },
		{ "@difftext.add", { fg = "black", bg = colors.bright_red, ctermfg = 0, ctermbg = 46 } },
		{ "@difftext.change", { fg = colors.white, bg = colors.boring_gray, ctermfg = 255, ctermbg = 239 } },
		...
		{ "PmenuSel", { fg = colors.white, bg = "#0a9dff", ctermfg = 255, ctermbg = 242 } },
		{ "PmenuSbar", { bg = "#857f78", ctermbg = 232 } },
		{ "PmenuThumb", { fg = "#242321", ctermfg = 81 } },
		{ "Search", { fg = colors.black, bg = "#FFE792", ctermfg = 0, ctermbg = 222 } },
